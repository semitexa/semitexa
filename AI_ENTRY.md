...
- **Canonical docs:** `packages/semitexa-docs/` — all of it, framework and package behaviour alike. A package carries no `docs/` prose. `var/docs/` is scratch. Root `./docs/` is **not** official.
